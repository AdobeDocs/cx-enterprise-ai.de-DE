...
Weitere Informationen finden Sie unter [Arbeiten mit MCP](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/integrations/ajo-mcp){target="_blank"}Clients in der Adobe Journey Optimizer-Dokumentation.
...
Weitere Informationen finden Sie unter [Content-Management-Tools](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/start/ajo-coworker-skills#content-management){target="_blank"} in der Dokumentation zu Adobe Journey Optimizer.
