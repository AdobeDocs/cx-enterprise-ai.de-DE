...
description: Erfahren Sie, wie Analytics-Admins die Datenvalidierungsfähigkeiten von Adobe Coworker verwenden, um Adobe Analytics- und Customer Journey Analytics-Daten während des Upgrades zu vergleichen.
hide: true
