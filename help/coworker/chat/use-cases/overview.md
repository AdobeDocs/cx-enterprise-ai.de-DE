...
| Beschleunigen von Überprüfungen und Genehmigungen | Mehrstufige Validierungen einrichten, Validierungsvorlagen anwenden, Genehmigende Personen hinzufügen/entfernen, Erinnerungen senden und Massenaktualisierungen durchführen | `manage-workfront-workflow` | Workfront-Workflow | „Erstellen Sie eine mehrstufige Genehmigung - Kopie, Entwurf, rechtliche Genehmigung - und erinnern Sie alle, die dies nicht genehmigt haben“ <br> „Entfernen Sie Chris Smith aus allen offenen Genehmigungen und ersetzen Sie durch Jane Francis“ |
