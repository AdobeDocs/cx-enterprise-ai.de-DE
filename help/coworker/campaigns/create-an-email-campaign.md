...
![Startbildschirm mit den drei verschiedenen Optionen für die ersten Schritte](./assets/create-an-email-campaign-1.png){width="800" zoomable="yes"}
...
1. Klicken Sie im Bereich _Kampagnenkonvertierung_ auf der linken Seite auf **CSV hochladen**.
...
Um Änderungen an Ihrer E-Mail vorzunehmen, scrollen Sie nach rechts. Klicken _unter „Campaign_&quot; auf **Editor öffnen**.
