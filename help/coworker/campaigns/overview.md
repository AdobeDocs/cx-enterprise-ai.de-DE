---
description: Erfahren Sie mehr über Adobe Coworker Campaign, eine KI-native Marketing-Anwendung, die eine einzelne Eingabeaufforderung in eine überprüfungsbereite Kampagne verwandelt.
title: Übersicht über Adobe Coworker
...
# Adobe Coworker Campaign - Übersicht {#overview}
...
1. (Optional) Laden Sie eine HTML-E-Mail-Vorlage unter **E-Mail-Vorlagen** hoch, damit Ihre Kampagnen-Designs beim Generieren von Inhalten angewendet werden.
   ...
   ![Willkommensbildschirm für die Testversion von Coworker Campaign](./assets/overview-1.png){width="800" zoomable="yes"}
...
- **Die Esc-Taste**. Drücken Sie die Esc-Taste jedes Mal, wenn Sie sich im Editor oder Dialogfeld eines Campaign-Mitarbeiters befinden (Kampagnen, Journey usw.) um schnell zu beenden.
